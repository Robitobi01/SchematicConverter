...
public class BlockStoneBrickStairs extends Block {
	...
	public BlockStoneBrickStairs() {
		super("stone_brick_stairs");
		setOldId(109);
		setOldName("stone_brick_stairs");
	...
	public Block getNewBlock() {
		Block block = new BlockStoneBrickStairs().setProperty(facing.getName(), facing.getPropertyByIndex(getMetaBits(facing.getMetadataBitCount(), facing.getMetadataIndexBit())));
	...
	public Block getOldBlock() {
		Block block = new BlockStoneBrickStairs().setMetadata(setMetaBits(facing.getCurrentIndex(), facing.getMetadataIndexBit()));
