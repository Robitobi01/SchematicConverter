...
public class BlockJungleFenceGate extends Block {
	...
	public BlockJungleFenceGate() {
		super("jungle_fence_gate");
		setOldId(185);
		setOldName("jungle_fence_gate");
	...
	public Block getNewBlock() {
		Block block = new BlockJungleFenceGate().setProperty(open.getName(), open.getPropertyByIndex(getMetaBits(open.getMetadataBitCount(), open.getMetadataIndexBit())));
	...
	public Block getOldBlock() {
		Block block = new BlockJungleFenceGate().setMetadata(setMetaBits(facing.getCurrentIndex(), facing.getMetadataIndexBit()));
