...
public class BlockDarkOakFenceGate extends Block {
	...
	public BlockDarkOakFenceGate() {
		super("dark_oak_fence_gate");
		setOldId(186);
		setOldName("dark_oak_fence_gate");
	...
	public Block getNewBlock() {
		Block block = new BlockDarkOakFenceGate().setProperty(open.getName(), open.getPropertyByIndex(getMetaBits(open.getMetadataBitCount(), open.getMetadataIndexBit())));
	...
	public Block getOldBlock() {
		Block block = new BlockDarkOakFenceGate().setMetadata(setMetaBits(facing.getCurrentIndex(), facing.getMetadataIndexBit()));
