...
public class BlockRedSandstoneStairs extends Block {
	...
	public BlockRedSandstoneStairs() {
		super("red_sandstone_stairs");
		setOldId(180);
		setOldName("red_sandstone_stairs");
	...
	public Block getNewBlock() {
		Block block = new BlockRedSandstoneStairs().setProperty(facing.getName(), facing.getPropertyByIndex(getMetaBits(facing.getMetadataBitCount(), facing.getMetadataIndexBit())));
	...
	public Block getOldBlock() {
		Block block = new BlockRedSandstoneStairs().setMetadata(setMetaBits(facing.getCurrentIndex(), facing.getMetadataIndexBit()));
