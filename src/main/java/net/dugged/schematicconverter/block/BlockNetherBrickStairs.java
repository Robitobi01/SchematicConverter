...
public class BlockNetherBrickStairs extends Block {
	...
	public BlockNetherBrickStairs() {
		super("nether_brick_stairs");
		setOldId(114);
		setOldName("nether_brick_stairs");
	...
	public Block getNewBlock() {
		Block block = new BlockNetherBrickStairs().setProperty(facing.getName(), facing.getPropertyByIndex(getMetaBits(facing.getMetadataBitCount(), facing.getMetadataIndexBit())));
	...
	public Block getOldBlock() {
		Block block = new BlockNetherBrickStairs().setMetadata(setMetaBits(facing.getCurrentIndex(), facing.getMetadataIndexBit()));
