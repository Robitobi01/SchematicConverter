...
public class BlockDarkOakStairs extends Block {
	...
	public BlockDarkOakStairs() {
		super("dark_oak_stairs");
		setOldId(164);
		setOldName("dark_oak_stairs");
	...
	public Block getNewBlock() {
		Block block = new BlockDarkOakStairs().setProperty(facing.getName(), facing.getPropertyByIndex(getMetaBits(facing.getMetadataBitCount(), facing.getMetadataIndexBit())));
	...
	public Block getOldBlock() {
		Block block = new BlockDarkOakStairs().setMetadata(setMetaBits(facing.getCurrentIndex(), facing.getMetadataIndexBit()));
