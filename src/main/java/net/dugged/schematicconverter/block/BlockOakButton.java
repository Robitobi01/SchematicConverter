...
public class BlockOakButton extends Block {
	...
	public Block getNewBlock() {
		Block block = new BlockOakButton().setProperty(powered.getName(), facing.getPropertyByIndex(getMetaBits(powered.getMetadataIndexBit(), powered.getMetadataBitCount())));
		switch (metadata) {
			case 1:
	...
	public Block getOldBlock() {
		Block block = new BlockOakButton().setMetadata(setMetaBits(powered.getMetadataBitCount(), powered.getMetadataIndexBit()));
