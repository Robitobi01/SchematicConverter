...
public class BlockSandstoneStairs extends Block {
	...
	public BlockSandstoneStairs() {
		super("sandstone_stairs");
		setOldId(128);
		setOldName("sandstone_stairs");
	...
	public Block getNewBlock() {
		Block block = new BlockSandstoneStairs().setProperty(facing.getName(), facing.getPropertyByIndex(getMetaBits(facing.getMetadataBitCount(), facing.getMetadataIndexBit())));
	...
	public Block getOldBlock() {
		Block block = new BlockSandstoneStairs().setMetadata(setMetaBits(facing.getCurrentIndex(), facing.getMetadataIndexBit()));
