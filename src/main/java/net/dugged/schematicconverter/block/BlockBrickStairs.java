...
public class BlockBrickStairs extends Block {
	...
	public Block getNewBlock() {
		Block block = new BlockBrickStairs().setProperty(facing.getName(), facing.getPropertyByIndex(getMetaBits(facing.getMetadataBitCount(), facing.getMetadataIndexBit())));
	...
	public Block getOldBlock() {
		Block block = new BlockBrickStairs().setMetadata(setMetaBits(facing.getCurrentIndex(), facing.getMetadataIndexBit()));
