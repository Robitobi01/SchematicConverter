...
public class BlockCobblestoneStairs extends Block {
	...
	public BlockCobblestoneStairs() {
		super("cobblestone_stairs");
		setOldId(67);
		setOldName("stone_stairs");
	...
	public Block getNewBlock() {
		Block block = new BlockCobblestoneStairs().setProperty(facing.getName(), facing.getPropertyByIndex(getMetaBits(facing.getMetadataBitCount(), facing.getMetadataIndexBit())));
	...
	public Block getOldBlock() {
		Block block = new BlockCobblestoneStairs().setMetadata(setMetaBits(facing.getCurrentIndex(), facing.getMetadataIndexBit()));
