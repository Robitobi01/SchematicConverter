...
public class BlockBirchStairs extends Block {
	...
	public Block getNewBlock() {
		Block block = new BlockBirchStairs().setProperty(facing.getName(), facing.getPropertyByIndex(getMetaBits(facing.getMetadataBitCount(), facing.getMetadataIndexBit())));
	...
	public Block getOldBlock() {
		Block block = new BlockBirchStairs().setMetadata(setMetaBits(facing.getCurrentIndex(), facing.getMetadataIndexBit()));
