...
public class BlockCobblestoneSlab extends Block {
	...
	public Block getOldBlock() {
		if (type.getValue().equals("double")) {
			return new BlockSmoothStoneDoubleSlab().setMetadata(3);
		} else {
			return new BlockSmoothStoneSlab().setMetadata(setMetaBits(3, type.getCurrentIndex(), 3));
		}
	}
}