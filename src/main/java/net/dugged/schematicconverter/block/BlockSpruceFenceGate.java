...
public class BlockSpruceFenceGate extends Block {
	...
	public BlockSpruceFenceGate() {
		super("spruce_fence_gate");
		setOldId(183);
		setOldName("spruce_fence_gate");
	...
	public Block getNewBlock() {
		Block block = new BlockSpruceFenceGate().setProperty(open.getName(), open.getPropertyByIndex(getMetaBits(open.getMetadataBitCount(), open.getMetadataIndexBit())));
	...
	public Block getOldBlock() {
		Block block = new BlockSpruceFenceGate().setMetadata(setMetaBits(facing.getCurrentIndex(), facing.getMetadataIndexBit()));
