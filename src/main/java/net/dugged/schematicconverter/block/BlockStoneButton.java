...
public class BlockStoneButton extends Block {
	...
	public Block getNewBlock() {
		Block block = new BlockStoneButton().setProperty(powered.getName(), facing.getPropertyByIndex(getMetaBits(powered.getMetadataIndexBit(), powered.getMetadataBitCount())));
		switch (metadata) {
			case 1:
	...
	public Block getOldBlock() {
		Block block = new BlockStoneButton().setMetadata(setMetaBits(powered.getMetadataBitCount(), powered.getMetadataIndexBit()));
